...
class movimiento:
    def mov(self, movimientoDerecha, movimientoIzquierda, cutderecha, cutIzquierda):
        self.x = []
        self.y = []
                    ...
                    if (self.movimientoIzquierda):
                        if (self.movimientoDerecha):
                            self.respuesta = input(
                                "Movimiento Derecha o Izquierda ?, Si es Derecha o Izquierda , si es Derecha responder con D y si es Izquierda con I ")
                ...
                if (str(Matrix[x][y]) == "O"):
                    if (not y == 7 and not y == 0):
                        ...
                        if (str(Matrix[x - 1][y + 1]) == " "):
                            self.movimientoDerecha = True
                    if (not y > 5 and y < 2):
                        if (str(Matrix[x - 1][y + 1]) == "X" and not str(Matrix[x - 2][y + 2]) == "X" and not str(
                                Matrix[x - 2][y + 2]) == "O"):
                            self.cutderecha = True
                        if (str(Matrix[x - 1][y - 1]) == "X" and not str(Matrix[x - 2][y - 2]) == "X" and not str(
                                Matrix[x - 2][y - 2]) == "O"):
